...
> **Catalog Statistics:** **432 Requirements Verified** across **930 Test Proofs** (345 Functional Capabilities, 87 Safety Guardrails).
...
| **`AUTH`** | Authentication, RBAC & Identity | **95** | 91 | 4 | 221 proofs |
