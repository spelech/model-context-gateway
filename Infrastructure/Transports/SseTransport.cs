...
namespace ModelContextGateway.Infrastructure.Transports
{
    public class SseTransport : ITransport
    {
        ...
        public SseTransport(McpServer server, HttpClient httpClient, ILogger logger, JsonRpcStateManager stateManager, ISecretRetriever? secretRetriever = null, string? passThroughToken = null, string? forwardedUser = null, IUserSecretStore? userSecretStore = null)
        {
