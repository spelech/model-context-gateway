...
![Version](https://img.shields.io/badge/version-v5.11.1-orange?style=for-the-badge)
...
| [**Enterprise AD, Vault & Auth Scenarios**](docs/enterprise-ad-vault-scenarios-and-gap-analysis.md) | Enterprise AD, Vault topology, downstream auth matrix, and gap analysis. |
